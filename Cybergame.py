...
...      "answer":0, "type":"mcq", "difficulty":"Beginner", "tgif":"🔒🧾🎯", "image":None},
...     # 2
...     {"id":2, "text":"True or False: A strong password should include only letters to make it easier to remember.",
...      "options":["True","False"], "answer":1, "type":"tf", "difficulty":"Beginner", "tgif":"🔑😅", "image":None},
...     # 3
...     {"id":3, "text":"Which of the following is a common sign of a phishing email?",
    ...
    {"id":5, "text":"Which protocol is used to securely browse the web?",
     ...
     "answer":3, "type":"mcq", "difficulty":"Beginner", "tgif":"🌐🔐", "image":None},
    # 6
    ...
    {"id":8, "text":"What does 'malware' stand for?",
     ...
     "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"🐛💻⚠️", "image":None},
    # 9
    ...
    {"id":10, "text":"Which of these practices improves security for web applications?",
     ...
     "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🛡️🧩", "image":None},
    # 11
    ...
    {"id":12, "text":"Which port is the default for HTTPS?",
     "options":["80","22","443","25"], "answer":2, "type":"mcq", "difficulty":"Beginner", "tgif":"🌐🔒", "image":None},
    # 13
    {"id":13, "text":"True or False: Using public Wi-Fi to access sensitive work resources without VPN is safe.",
     "options":["True","False"], "answer":1, "type":"tf", "difficulty":"Beginner", "tgif":"📶⚠️", "image":None},
    # 14
    ...
    {"id":16, "text":"What does 'XSS' stand for in web security?",
     ...
     "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🌐⚠️💬", "image":None},
    # 17
    ...
    {"id":19, "text":"True or False: HTTPS guarantees a website is completely safe and trustworthy.",
     "options":["True","False"], "answer":1, "type":"tf", "difficulty":"Intermediate", "tgif":"🔒❗", "image":None},
    # 20
    ...
    {"id":25, "text":"Which header indicates a site uses Content Security Policy to reduce XSS?",
     ...
     "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧱📜", "image":None},
    # 26
    {"id":26, "text":"True or False: A DMARC record helps reduce email spoofing.",
     "options":["True","False"], "answer":0, "type":"tf", "difficulty":"Intermediate", "tgif":"📧🛡️", "image":None},
    # 27
    ...
    {"id":30, "text":"What does 'least privilege' help to reduce?",
     ...
     "answer":0, "type":"mcq", "difficulty":"Beginner", "tgif":"📉🛡️", "image":None},
    # 31
    ...
    {"id":33, "text":"Which method would an attacker use to intercept data between two parties?",
     ...
     "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🕵️‍♂️🔗", "image":None},
    # 34
    ...
    {"id":40, "text":"Which attack exploits weaknesses in authentication flows to impersonate users?",
     ...
     "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧾🔓", "image":None},
    # 41
    ...
    {"id":42, "text":"Which HTTP method is commonly used to submit form data securely (with TLS)?",
     "options":["GET","POST","DELETE","OPTIONS"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"🔁🌐", "image":None},
    # 43
    ...
    {"id":51, "text":"Which file extension is commonly used for malicious Windows executables?",
     "options":[".exe",".jpg",".txt",".mp3"], "answer":0, "type":"mcq", "difficulty":"Beginner", "tgif":"🧾💥", "image":None},
    # 52
    ...
    {"id":53, "text":"Which of these is used to map domain names to IP addresses?",
     "options":["HTTP","DNS","SMTP","FTP"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"📛➡️🔢", "image":None},
    # 54
    ...
    {"id":55, "text":"Which of these is a privacy regulation from the EU?",
     "options":["GDPR","HIPAA","PCI-DSS","SOX"], "answer":0, "type":"mcq", "difficulty":"Beginner", "tgif":"🇪🇺🛡️", "image":None},
    # 56
    {"id":56, "text":"Which tool category is 'nmap'?",
     "options":["Vulnerability scanner","Network discovery/port scanner","Password manager","Encryption tool"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧭🔍", "image":None},
    # 57
    {"id":57, "text":"True or False: Backing up data protects you fully from ransomware.",
     "options":["True","False"], "answer":1, "type":"tf", "difficulty":"Intermediate", "tgif":"💾🔒", "image":None},
    # 58
    {"id":58, "text":"What does MFA stand for?",
     "options":["Multiple File Access","Multi-Factor Authentication","Managed File Authorization","Many-Folder Access"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"🔐🔁", "image":None},
    # 59
    ...
    {"id":62, "text":"True or False: A VPN hides all malicious activity from your employer.",
     "options":["True","False"], "answer":1, "type":"tf", "difficulty":"Intermediate", "tgif":"🕵️‍♀️🚫", "image":None},
    # 63
    {"id":63, "text":"Which of these is used for secure remote shell access?",
     "options":["FTP","SSH","Telnet","HTTP"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"🔒🖥️", "image":None},
    # 64
    ...
    {"id":65, "text":"Which tool category is 'Wireshark'?",
     "options":["Network protocol analyzer","Web server","Database","Password manager"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"📡🔬", "image":None},
    # 66
    ...
    {"id":68, "text":"What is an API key supposed to be treated as?",
     "options":["Public information","Secret credential","Database index","CSS style"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔑🧾", "image":None},
    # 69
    {"id":69, "text":"Which of these is NOT part of secure SDLC?",
     "options":["Threat modeling","Code review","Ignoring user input","Penetration testing"], "answer":2, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔁🛠️", "image":None},
    # 70
    ...
    {"id":71, "text":"Which of these is used to uniquely identify a device on a network?",
     "options":["MAC Address","Username","Folder name","Process ID"], "answer":0, "type":"mcq", "difficulty":"Beginner", "tgif":"🔢📶", "image":None},
    # 72
    {"id":72, "text":"Which control addresses insider threats the best?",
     "options":["Monitoring and access controls","Turning off all systems","Granting everyone admin rights","Leaving logs disabled"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"👀🔐", "image":None},
    # 73
    {"id":73, "text":"What does 'PCI-DSS' relate to?",
     "options":["Healthcare records","Payment card industry security standard","DNS configuration","Operating system updates"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"💳🛡️", "image":None},
    # 74
    ...
    {"id":75, "text":"Which of these is the best place to store secrets in production?",
     "options":["Plain text files in repo","Secrets manager (vault)","Public bucket","Shared spreadsheets"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🗝️🏦", "image":None},
    # 76
    {"id":76, "text":"Which of the following indicates a weak security practice?",
     "options":["Unique per-user passwords","Password reuse across sites","MFA","Account lockout after many attempts"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"♻️🔓", "image":None},
    # 77
    {"id":77, "text":"What is the goal of 'red team' exercises?",
     "options":["Patch systems","Act like attackers to test defenses","Manage backups","Write documentation"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔴⚔️", "image":None},
    # 78
    ...
    {"id":81, "text":"What does 'SLA' stand for in operational contexts?",
     "options":["Security Log Analytics","Service Level Agreement","System Log Archive","Secure Layer Access"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"📜🤝", "image":None},
    # 82
    {"id":82, "text":"Which of these is an example of physical security control?",
     "options":["Encryption at rest","Biometric access to server room","Firewall rules","Password policies"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"🔒🏢", "image":None},
    # 83
    ...
    {"id":84, "text":"Which is the most important when creating a secure password policy?",
     "options":["Mandating extremely short passwords","Balancing complexity and usability plus encouraging passphrases","Allowing password reuse","No expiration at all"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔐💡", "image":None},
    # 85
    {"id":85, "text":"What is the best definition of 'phishing simulation' used in training?",
     "options":["A real attack without consent","A fake phishing exercise to test/training users","Email marketing campaign","A backup procedure"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"🧪🎣", "image":None},
    # 86
    {"id":86, "text":"Which of these is a common cause of accidental data leakage?",
     "options":["Strong encryption","Misconfigured cloud storage buckets","Multi-factor auth","Stringent access controls"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"☁️🔓", "image":None},
    # 87
    ...
    {"id":88, "text":"What is 'privilege escalation'?",
     "options":["Losing permissions","Gaining higher permissions than allowed","Deleting user accounts","Changing wallpaper"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"⬆️👑", "image":None},
    # 89
    {"id":89, "text":"Which of these steps is first during incident response?",
     "options":["Containment","Eradication","Preparation and identification","Recovery"], "answer":2, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧯📋", "image":None},
    # 90
    ...
    {"id":91, "text":"What does 'IOC' stand for in threat hunting?",
     "options":["Indicator of Compromise","Internet of Components","Index of Credentials","Initial Owned Computer"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔎⚠️", "image":None},
    # 92
    {"id":92, "text":"Which practice helps reduce phishing click rates?",
     "options":["User awareness training","Auto-accept files","Disable MFA","Use default passwords"], "answer":0, "type":"mcq", "difficulty":"Beginner", "tgif":"🎓📧", "image":None},
    # 93
    ...
    {"id":94, "text":"Which of the following best describes 'defense in depth'?",
     "options":["Multiple layers of security controls","One strong control only","No controls","Outsource everything"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧱🧱🧱", "image":None},
    # 95
    {"id":95, "text":"Which is commonly used to persist malicious activity across reboots?",
     "options":["Modifying startup scripts or registry entries","Deleting logs","Using strong passwords","Running backups"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔁👾", "image":None},
    # 96
    {"id":96, "text":"What is 'DNS poisoning' used for?",
     "options":["Speeding DNS resolution","Redirecting domain names to malicious IPs","Encrypting DNS","Blocking DNS entirely"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧪🌐", "image":None},
    # 97
    ...
    {"id":98, "text":"Which of the following is a form of biometric authentication?",
     "options":["OTP over email","Fingerprint scanner","Password manager","Firewall rule"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"🖐️🔒", "image":None},
    # 99
    {"id":99, "text":"Which approach helps to protect API endpoints?",
     "options":["Rate limiting, auth tokens, input validation","Opening all ports","Using admin credentials in code","No logging"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔐🧩", "image":None},
    # 100
    ...
    {"id":105, "text":"Which of these is a common mistake leading to data exposure in cloud services?",
     "options":["Misconfigured access control lists or public buckets","Strict IAM policies","Encryption by default","MFA enforcement"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"☁️🔓", "image":None},
    # 106
    ...
    {"id":108, "text":"Which of the following is a kind of advanced persistent threat (APT) hallmark?",
     ...
     "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🕵️‍♀️🕰️", "image":None},
    # 109
    ...
    {"id":110, "text":"What is 'cryptographic nonce' used for?",
     "options":["Ensure uniqueness to prevent replay attacks","Act as a master password","Compress data","Format logs"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔢🛡️", "image":None},
    # 111
    ...
    {"id":114, "text":"Which technique is used to obscure real IP addresses for anonymity?",
     "options":["VPN and Tor","Plain HTTP","FTP only","SMTP"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🕸️🛡️", "image":None},
    # 115
    ...
    {"id":116, "text":"What is 'certificate revocation' used for?",
     "options":["Remove trust from compromised or invalid certificates","Make certificates stronger","Accelerate TLS handshake","Generate new keys automatically"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"📛❌", "image":None},
    # 117
    {"id":117, "text":"Which of these indicates possible credential compromise?",
     "options":["Multiple failed logins followed by success from unusual location","Single successful login from familiar device","Planned maintenance","Scheduled backup"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🚨📍", "image":None},
    # 118
    ...
    {"id":119, "text":"Which is a function of DLP (Data Loss Prevention) tools?",
     "options":["Prevent unauthorized data exfiltration","Distribute malware","Format disks","Change passwords automatically"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🚫📤", "image":None},
    # 120
    {"id":120, "text":"Which of the following is a code injection attack?",
     "options":["SQL injection","DDoS","Phishing","Brute force"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧩⚠️", "image":None},
    # 121
    ...
    {"id":122, "text":"What is 'cyber hygiene'?",
     "options":["Daily personal cleaning tasks","Practices to maintain system security like patching, backups, passwords","Disaster recovery plan only","Antivirus installation only"], "answer":1, "type":"mcq", "difficulty":"Beginner", "tgif":"🧼💻", "image":None},
    # 123
    {"id":123, "text":"Which of the following helps protect credentials in applications?",
     "options":["Store credentials in code","Use environment variables and secrets manager","Share credentials in chat","Hardcode credentials"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🛡️🔑", "image":None},
    # 124
    ...
    {"id":125, "text":"Which authentication standard is commonly used for federated logins (social login)?",
     "options":["OAuth 2.0 / OpenID Connect","FTP","SMTP","SNMP"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔗🆔", "image":None},
    # 126
    {"id":126, "text":"Which is a sign of credential stuffing in logs?",
     "options":["Many login attempts for many accounts from same IP","Single login attempt","Single logout","Regular backups"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧪🔁", "image":None},
    # 127
    ...
    {"id":128, "text":"Which of the following is a good practice for container security?",
     "options":["Run containers as root in production","Use minimal base images and least privilege","Publish secret env vars in public repo","Disable resource limits"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"🐳🔐", "image":None},
    # 129
    {"id":129, "text":"Which of these is a valid reason to perform a vulnerability scan?",
     "options":["To find potential weaknesses to remediate","To break production systems unintentionally","To exfiltrate data","To disable logs"], "answer":0, "type":"mcq", "difficulty":"Beginner", "tgif":"🔎🩺", "image":None},
    # 130
    ...
    {"id":131, "text":"What is the best immediate action when a malware infection is confirmed on a workstation?",
     "options":["Isolate the workstation from the network","Continue normal operations","Delete system32","Reboot repeatedly"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🚪🔒", "image":None},
    # 132
    {"id":132, "text":"Which of the following helps detect abnormal user behavior?",
     "options":["UEBA (User and Entity Behavior Analytics)","Only antivirus","Only firewall rules","No logs"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"👤📈", "image":None},
    # 133
    ...
    {"id":134, "text":"Which of these is recommended for secure remote workforce?",
     "options":["Enforce MFA, VPN or Zero Trust access, device posture checks","Allow any device without checks","Share one password for all","Disable authentication"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🏠🛡️", "image":None},
    # 135
    {"id":135, "text":"What is 'exfiltration' in cyber security?",
     "options":["Moving data legally between departments","Stealing data out of a network","Encrypting backups","Installing updates"], "answer":1, "type":"mcq", "difficulty":"Intermediate", "tgif":"📤🚨", "image":None},
    # 136
    ...
    {"id":137, "text":"Which of these is a good practice when designing APIs?",
     "options":["Use strong auth, validate inputs, rate-limit, and log","Trust all client input","Return full stack traces to clients","Use hardcoded secrets"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🧭🔐", "image":None},
    # 138
    {"id":138, "text":"Which of these is a hallmark of ransomware?",
     "options":["Data encrypted and ransom note demanding payment","Faster file access","Lighter CPU usage","Improved performance"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"💸🔒", "image":None},
    # 139
    ...
    {"id":140, "text":"Which of these helps defend against supply chain attacks?",
     "options":["Vendor vetting, SBOMs, security requirements in contracts","No vendor checks","Blindly trusting third parties","Disable monitoring"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔗📜", "image":None},
    # 141
    {"id":141, "text":"Which of these is an example of 'security through transparency' benefit?",
     "options":["Open review of designs reduces hidden vulnerabilities","Hiding designs prevents attackers","Ignoring audits","No logging"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔍🤝", "image":None},
    # 142
    ...
    {"id":143, "text":"Which term describes attackers selling access to compromised systems?",
     "options":["Initial access broker","Penetration tester","Bug bounty hunter","Red teamer"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"💼🔓", "image":None},
    # 144
    {"id":144, "text":"Which of the following is a strong indicator of phishing URL?",
     "options":["Misspelt domain and strange subdomains","Short domain with correct spelling","Company email domain","Secure padlock icon only"], "answer":0, "type":"mcq", "difficulty":"Beginner", "tgif":"🔗🎣", "image":None},
    # 145
    ...
    {"id":146, "text":"What is 'tokenization' typically used for?",
     "options":["Replacing sensitive data with non-sensitive tokens","Increasing CPU speed","Compressing files","Backing up data"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"🔁🔐", "image":None},
    # 147
    {"id":147, "text":"Which control helps detect suspicious exfiltration over DNS?",
     "options":["DNS logging and anomaly detection","Disable DNS entirely","Use only plain text emails","Always allow DNS tunneling"], "answer":0, "type":"mcq", "difficulty":"Advanced (but approachable)","tgif":"🐾🌐", "image":None},
    # 148
    ...
    {"id":149, "text":"Which of these is most useful for tracking software dependencies and licenses?",
     "options":["SBOM (Software Bill of Materials)","Plain text README","Binary blobs","Random notes"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"📜🧾", "image":None},
    # 150
    {"id":150, "text":"Which of these is an effective anti-phishing UI feature in email clients?",
     "options":["Display sender verification, show warnings for spoofed senders","Always trust external senders","Auto-open attachments","Hide sender details"], "answer":0, "type":"mcq", "difficulty":"Intermediate", "tgif":"⚠️📧🔒", "image":None},
]
...
<head>
  <meta charset="utf-8">
  <title>Coding Temple — Cyber Trivia Game Night</title>
...
<body>
  <header>
    <div class="brand">🎮 Coding Temple — Cyber Trivia Night <span class="muted" style="font-size:13px; margin-left:8px;">(Beginner → Intermediate)</span></div>
    <div class="muted">TGIF emoji tags = 🔒 security / 🎣 phishing / 🧠 concepts</div>
  </header>
  ...
  <div class="container">
    <div class="controls">
      ...
      <div style="margin-left:auto; display:flex; gap:8px; align-items:center;">
        ...
        <div class="die" id="dieResult">—</div>
...
def api_question(q_id):
    ...
    # Return question but do NOT include 'answer' index — frontend must call /api/answer to check
